...
import about from "../views/concerning/about.vue";
import info from "../views/concerning/info.vue";
import conferenceroom from "../views/conferenceroom/conferenceroom.vue";
import amend from "../views/amend/amend.vue"; //修改手机号码

import firm from "../views/subjobs/firm.vue"; //招聘企业
import corporation from "../views/corporation/corporation.vue"; //公司详情
let routes = [{
        path: "/",
